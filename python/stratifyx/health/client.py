...
from .types.get_api_v1health_response import GetApiV1HealthResponse
...
class HealthClient:
    ...
    def health_check_v1alias(
        ...
        client.health.health_check_v1alias()
        """
        _response = self._raw_client.health_check_v1alias(request_options=request_options)
...
class AsyncHealthClient:
    ...
    async def health_check_v1alias(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> GetApiV1HealthResponse:
        """
        Health check
        ...
        async def main() -> None:
            await client.health.health_check_v1alias()


        asyncio.run(main())
        """
        _response = await self._raw_client.health_check_v1alias(request_options=request_options)
        return _response.data
