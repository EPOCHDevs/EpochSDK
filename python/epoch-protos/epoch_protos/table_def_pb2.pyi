...
class ColumnDef(_message.Message):
    __slots__ = ("id", "name", "type", "decimal_places")
    ...
    decimal_places: int
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., type: _Optional[_Union[_common_pb2.EpochFolioType, str]] = ..., decimal_places: _Optional[int] = ...) -> None: ...
...
class CardData(_message.Message):
    __slots__ = ("title", "value", "type", "group", "decimal_places")
    TITLE_FIELD_NUMBER: _ClassVar[int]
    ...
    group: int
    decimal_places: int
    def __init__(self, title: _Optional[str] = ..., value: _Optional[_Union[_common_pb2.Scalar, _Mapping]] = ..., type: _Optional[_Union[_common_pb2.EpochFolioType, str]] = ..., group: _Optional[int] = ..., decimal_places: _Optional[int] = ...) -> None: ...
