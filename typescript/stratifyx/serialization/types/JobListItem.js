...
const JobListItemStatus_1 = require("./JobListItemStatus");
const JobPeriod_1 = require("./JobPeriod");
exports.JobListItem = core.serialization.object({
    id: core.serialization.string(),
    definitionId: core.serialization.property("definition_id", core.serialization.string()),
    status: JobListItemStatus_1.JobListItemStatus,
    period: JobPeriod_1.JobPeriod.optionalNullable(),
